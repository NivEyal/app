...
class SubmissionsController < ApplicationController
  ...
  load_and_authorize_resource :submission, only: %i[show destroy update]
  ...
  def update
    ...
    if params[:decision] == "keep"
      @submission.update(status: "kept")
    elsif params[:decision] == "discard"
      @submission.destroy
    end
    
    redirect_to submissions_path, notice: "Decision applied."
  end
